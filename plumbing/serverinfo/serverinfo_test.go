...
func (s *ServerInfoSuite) assertInfoRefs(st storage.Storer, fs billy.Filesystem) {
...
func (s *ServerInfoSuite) assertObjectPacks(st storage.Storer, fs billy.Filesystem) {
...
func (s *ServerInfoSuite) TestUpdateServerInfoTags() {
	...
	s.assertInfoRefs(st, fs)
	s.assertObjectPacks(st, fs)
}
